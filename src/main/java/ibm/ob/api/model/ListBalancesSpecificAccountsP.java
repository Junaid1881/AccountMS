...
public class ListBalancesSpecificAccountsP {
    ...
    public ListBalancesSpecificAccountsP(String xV,RequestAccountIds accountIds,Integer page,Integer pageSize,String xMinV,String xFapiInteractionId,String xFapiAuthDate,String xFapiCustomerIpAddress,String xCdsUserAgent,String xCdsSubject) {
        this.xV = xV;
