...
public class ListAccountsP {
    ...
    public ListAccountsP() {

    }

    public ListAccountsP(String xV,String productCategory,String openStatus,Boolean isOwned,Integer page,Integer pageSize,String xMinV,String xFapiInteractionId,String xFapiAuthDate,String xFapiCustomerIpAddress,String xCdsUserAgent,String xCdsSubject) {
        this.xV = xV;
